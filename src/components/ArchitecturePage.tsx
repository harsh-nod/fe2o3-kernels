      ...
      <section>
        ...
        <div className="architecture-rows">
          {[
            ...
            ["Compiler analyses", "Run the eight ordered tensor, bounds, atomic, race, hierarchy-ownership, barrier, workgroup-memory, and semantic checks; an ephemeral manager shares sparse-index, execution-layout, exact-trace, and tensor-layout dataflow facts only within one validation."],
