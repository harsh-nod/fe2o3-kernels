...
const records: AdvancedPerformanceRecord[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Campaign commit: 109e1966d36d4188c43cafe5cb455c1ac3dd0767; the final displayed kernel and oracle are byte-identical, while the final a542 crate wrapper rerun remains outstanding.",
      "",
      "MEASURED RESULT",
      "Production Rust fused: median 1.068124 ms; bootstrap 95% CI [1.067445, 1.068925] ms.",
      "Exact unfused HIP router + attention + expert: median 0.780683 ms; bootstrap 95% CI [0.780563, 0.780844] ms.",
      "The exact unfused sequence is 0.7309x the fused duration; fused is 1.3682x slower.",
      ...
      "Fused/resource floor = 5,659x; exact comparator/resource floor = 4,136x.",
