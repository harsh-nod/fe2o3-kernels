...
const progressNarrativeRegistry = deepFreeze({
  ...
  "progress/gfx942-wave64-lds-reduction": "V2 is identical on both public mains with green hosted policy and generic workflows. It binds canonical gfx942:xnack- through Kernel IR and Worker V2, rejects eleven unauthorized target forms, and passes 6/26 Verus plus 256-lane MI300X evidence. Public descendant d592ecee1154ca39daf1f9b1c2e02ab462e6c5f8 separately adds ordinary attributed Phase A sources, checked CPU oracles, deterministic mutations, and Verus models for masked Wave64 reduction/scans and workgroup synchronization. The synchronization source uses DeviceGlobalMutPtr for global address-space identity, generated exclusive GlobalMut host admission, and an exact linear DynamicLds capability. Those source-level capabilities are not joined to compiler collector/lowering, a profile or descriptor, finalization, generated host/runtime launch, or protected gfx942 execution.",
