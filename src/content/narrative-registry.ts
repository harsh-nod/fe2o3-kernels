  ...
  "read-the-evidence/scalar-gemm-checkpoint": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "text": "The checked-in publication gate names public-main implementation commit 4138e034b7ee9f457d9b63b4d54bdc623d0c8046, tree a5f8ac44fd69b7a69662c73fb8931399be0ab241, while historical lesson claims remain separately pinned. Both harsh-nod/fe2o3@refs/heads/main and powderluv/fe2o3@refs/heads/main resolve exactly to that descendant, and deployment continues to require that exact match. The protected GEMM implementation and measured evidence remain pinned to c4fcb4d980cf979c0527dfa135a7b9f4fe72a811, tree c65c6ab567409afaaef6ea39c8befcac21d47119. The Wave64 and synchronization Phase A source snapshots remain pinned to d592ecee1154ca39daf1f9b1c2e02ab462e6c5f8, tree cdec8448a300aa71d17565ca50fd4d893932f602. The current public snapshot adds broker fixture isolation; row-softmax certificate, exact finalizer join, typed host adapter, private linear HSA lifecycle, and fail-closed protected harness; checkout-relocatable exact compiler profiles for Wave64 and synchronization; and deterministic Wave64 in-process upstream LLVM target emission plus LLD library linking with exact post-link metadata, resource, relocation, dependency, unresolved-symbol, and machine-call checks. Wave64 now also has a typed one-shot HSA lifecycle and one protected gfx942 observation over four exact masks with canaries, unchanged inputs, exact-bit outputs, and terminal unload. That observation does not establish compiler or Verus-to-machine refinement. Synchronization now has opaque direct upstream LLVM target-machine plus in-process LLD finalization for the fixed LDS-reduction and scoped-atomic profiles, typed arguments, profile-bound host admission, private one-shot host/runtime lifecycles, exact dynamic-LDS AQL binding, and protected vectors. Both Rust handoffs now bind the canonical layout derived through upstream LLVM 22 TargetMachine::createDataLayout(), and exact admission rejects stale, missing, reordered, and substituted layouts. Both exact kernels passed the normal measured-worker MI300X lifecycle in debug and release with canaries, unchanged inputs, exact oracles, bounded completion, and terminal unload. That observation does not establish generalized memory safety, race freedom, or source/compiler/machine refinement. The exact B=1, H=1, N=8, D=16 causal FlashAttention source has an independent two-pass FP64 oracle, executable proof-facing models, debug/release vectors, mutation rejection tests, a pinned Verus proof of the rational online recurrence, bounds, reference correspondence, and exclusive output ownership, and exact compiler admission binding attributed source, FnAbi, complete reachable portable MIR, semantic Kernel IR, and V3 provider identity. It does not prove exponential-law, IEEE FP32/OCML, artifact finalization, runtime, hardware, or source/model-to-machine authority. The exact T=8, E=4, K=2, C=4 MoE top-2 source has deterministic finite-FP32 selection, lower-expert tie breaking, stable capacity dropping, exclusive offsets, permutation and inverse maps, an independent oracle, a 6,561-case corpus, debug/release tests, hostile mutations, a pinned Verus proof of the mathematical routing policy, and exact compiler admission binding attributed source, FnAbi, complete reachable portable MIR, semantic Kernel IR, target/ABI/resources, and V3 provider identity. It does not prove IEEE FP32/source refinement, LLVM finalization, runtime, hardware, or source/model-to-machine authority. The row-softmax protected run is still unclaimed at this snapshot because the MI300X environment supplied 0 of its 25 exact compiler, worker, and OCML pins. None of these increments retroactively strengthens the bounded protected GEMM observation or combines authenticated compiler origin, compiler refinement, final machine semantics, generalized safety, and execution into one authority chain."
      }
    ]
  },
...
const reviewedNarrativeFingerprints = deepFreeze({
  ...
  "read-the-evidence/scalar-gemm-checkpoint":
    "6ca3a82c78342ce219451a629ea0ec114e3257cc00d5fd29dd925951cb4e4ed6",
  "reductions-scans/scan":
