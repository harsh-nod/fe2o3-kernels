  ...
  "read-the-evidence/scalar-gemm-checkpoint": {
    ...
    "blocks": [
      ...
      },
      {
        "type": "callout",
        "tone": "boundary",
        "title": "Current integration checkpoint",
