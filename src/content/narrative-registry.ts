  ...
  "read-the-evidence/scalar-gemm-checkpoint": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "text": "The checked-in publication gate names public-main implementation commit ebaf1d87ca6f35eba0c321e7cf2aac62ba9eebdc, tree b2c2f04a3c8b1f207b45b86af1a9108f86e251a3, while lesson claim badges remain pinned to FE2O3_PIN until a separate baseline audit. Both harsh-nod/fe2o3@refs/heads/main and powderluv/fe2o3@refs/heads/main resolve exactly to that descendant, and deployment continues to require that exact match. The protected GEMM implementation and measured evidence remain pinned to c4fcb4d980cf979c0527dfa135a7b9f4fe72a811, tree c65c6ab567409afaaef6ea39c8befcac21d47119. The Wave64 and synchronization Phase A snapshots remain pinned to d592ecee1154ca39daf1f9b1c2e02ab462e6c5f8, tree cdec8448a300aa71d17565ca50fd4d893932f602. The current public snapshot adds broker fixture isolation; row-softmax certificate, exact finalizer join, typed host adapter, private linear HSA lifecycle, and fail-closed protected harness; an exact source-derived Wave64 compiler profile; and deterministic Wave64 in-process upstream LLVM target emission plus LLD library linking with exact post-link metadata, resource, relocation, dependency, unresolved-symbol, and machine-call checks. Wave64 still has no generated runtime launch, protected hardware observation, or Verus-to-machine refinement. Synchronization still stops before a location-independent compiler profile is accepted. The exact B=1, H=1, N=8, D=16 FP32 causal FlashAttention Phase A source has an independent two-pass FP64 oracle, executable proof-facing models, 24 debug vectors, 24 release vectors, and mutation rejection tests. The exact T8/E4/K2/C4 MoE top-2 Phase A source adds deterministic finite-FP32 selection, lower-expert tie breaking, stable capacity dropping, exclusive offsets, permutation and inverse maps, an independent oracle, a 6,561-case corpus, 24 debug and 24 release tests, executable proof-facing models, and hostile mutations. Neither advanced Phase A source has Verus, compiler, artifact, runtime, or hardware authority. The row-softmax protected run is also still unclaimed because the MI300X environment supplied 0 of its 25 exact compiler, worker, and OCML pins. None of these increments retroactively strengthens the bounded protected GEMM observation or combines authenticated compiler origin, compiler refinement, final machine semantics, generalized safety, and execution into one authority chain."
      }
    ]
  },
...
const reviewedNarrativeFingerprints = deepFreeze({
  ...
  "read-the-evidence/scalar-gemm-checkpoint":
    "8433e0db376185a798b77ad99991775473a1f42815b53734ec9c807a843c5abb",
  "reductions-scans/scan":
