  ...
  "read-the-evidence/scalar-gemm-checkpoint": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "text": "The checked-in publication gate names integrated public-main commit d65449e2092929f73b9cdee91c039fae3b61ecff, tree 867ea9422bb5f721166d3ea829190c3b3debcc91. Deployment requires both harsh-nod/fe2o3@refs/heads/main and powderluv/fe2o3@refs/heads/main to resolve to that exact commit and tree. Historical lesson evidence remains independently pinned: protected GEMM stays at c4fcb4d980cf979c0527dfa135a7b9f4fe72a811, tree c65c6ab567409afaaef6ea39c8befcac21d47119; Wave64 and synchronization Phase A source stay at d592ecee1154ca39daf1f9b1c2e02ab462e6c5f8, tree cdec8448a300aa71d17565ca50fd4d893932f602; and 96b9890c3ad33ad8c6b4239a9b567728a176d65f, tree f911f0c693238830ad6070b2674fb863857bfec1, remains a historical audited public baseline rather than the current tip. The integrated checkpoint retains the bounded protected GEMM, Wave64, and workgroup-synchronization observations and the fixed FlashAttention and MoE source, proof, compiler, finalizer, and typed-runtime layers under each layer's existing limits. Its GPU code-object path uses pinned upstream LLVM target-machine APIs plus in-process LLD. Row-softmax now also has a distinct LLVM release pair: A 31bf96a21c0a2bbfb55c44f9a22b7350cabcfcb1, tree 293c6d39e47d64f5949d450d6041dc598aafd0fe, and manifest B fd89390788adc5670c54ecc2517b9720f2f80113, tree af0156687517c0e71eb0d607917964b7c375af43, with manifest SHA-256 9c7dc4a08f2f972b581ffa0f88bf8834d2098f21ff57b1a8594dd4dfca03759c and two independent complete MI300X release gates. Those release gates did not dispatch a GPU and grant no runtime, authentication, or source/model/Verus-to-machine refinement authority. Bounded MoE V2 is integrated and publication-gated, but its gfx942 upload/readback test dispatches no kernel; it grants no router or expert GPU execution, generalized source-to-machine refinement, numerical or performance result, memory-safety authority, or race-freedom authority. All relevant advanced-kernel rows therefore remain Partial. Zero Missing records inventory coverage, not cuda-oxide parity."
      }
    ]
  },
...
const reviewedNarrativeFingerprints = deepFreeze({
  ...
  "read-the-evidence/scalar-gemm-checkpoint":
    "8b705879642db407a5a2c60f21aa70bb7b459f6ff3e216de6189d789b4909de7",
  "reductions-scans/scan":
