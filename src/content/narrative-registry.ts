    ...
    "blocks": [
      {
        ...
        "items": [
          ...
          "The production transaction stops before target IR, finalization, or artifact publication."
        ]
      },
      {
        "type": "callout",
