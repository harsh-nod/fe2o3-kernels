  ...
  "read-the-evidence/scalar-gemm-checkpoint": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "text": "The checked-in publication gate requires commit 2042382cb07283c4339c05c6372c6798bd5ceb7b, tree e4a964c61dd43e1ac5e54adc2562f6e77f2e6654. Deployment remains gated until both harsh-nod/fe2o3@refs/heads/main and powderluv/fe2o3@refs/heads/main resolve to that exact commit and tree. Historical lesson evidence remains independently pinned: protected GEMM stays at c4fcb4d980cf979c0527dfa135a7b9f4fe72a811, tree c65c6ab567409afaaef6ea39c8befcac21d47119; Wave64 and synchronization Phase A source stay at d592ecee1154ca39daf1f9b1c2e02ab462e6c5f8, tree cdec8448a300aa71d17565ca50fd4d893932f602; and 96b9890c3ad33ad8c6b4239a9b567728a176d65f, tree f911f0c693238830ad6070b2674fb863857bfec1, remains a historical audited public baseline rather than the current tip. The integrated checkpoint retains the bounded protected GEMM, Wave64, and workgroup-synchronization observations and the fixed FlashAttention and MoE source, proof, compiler, finalizer, and typed-runtime layers under each layer's existing limits. Its device code-object path uses pinned upstream LLVM target-machine APIs plus in-process LLD, with no COMGR or shell GPU linker. Row-softmax also has a distinct LLVM release pair: A 31bf96a21c0a2bbfb55c44f9a22b7350cabcfcb1, tree 293c6d39e47d64f5949d450d6041dc598aafd0fe, and manifest B fd89390788adc5670c54ecc2517b9720f2f80113, tree af0156687517c0e71eb0d607917964b7c375af43, with manifest SHA-256 9c7dc4a08f2f972b581ffa0f88bf8834d2098f21ff57b1a8594dd4dfca03759c. Two fresh complete MI300X runs passed; independent review accepted the evidence package, including the single retained HSACO identity 0864047320a7ade5eba29d3fbb3ef9efefcf2a1378097061010d163af461db93. Those runs did not dispatch a GPU and grant no runtime, authentication, or source/model/Verus-to-machine refinement authority. Bounded MoE V2 is integrated and publication-gated, but its gfx942 upload/readback test dispatches no kernel; it grants no router or expert GPU execution, generalized source-to-machine refinement, numerical or performance result, memory-safety authority, or race-freedom authority. Candidate 2e5ad53bcb20f2a46e91128a42e838d918d61581, tree 892f014381cd3e34f81cb05df3b9bbda4a412478, remains rejected and is not integrated, accepted, or public. It crossed the static binding-wrapper, Cargo, rustc, backend, and kernel-collection boundaries, then failed closed on missing authenticated cargo-fe2o3 broker identity with zero Worker executions and no artifact admission, load, dispatch, GPU result, or COMGR path. Its dynamic host rust-lld left the ELF loader and system DSOs, CRTs, archives and objects, search roots, and forwarded Cargo artifacts unauthenticated; env_clear is insufficient. W0 is a dedicated, genuinely static fe2o3-host-lld from pinned upstream LLVM/LLD archives plus descriptor-backed HostLinkClosureV1 and pre-link and post-link revalidation. W1 is authenticated broker cargo-fe2o3 executable identity and follows W0. Retaining dynamic rust-lld is rejected, while in-process host LLD is deferred. All relevant advanced-kernel rows therefore remain Partial. This rejection promotes no parity or evidence row, and Zero Missing records inventory coverage rather than cuda-oxide parity."
      }
    ]
  },
...
const reviewedNarrativeFingerprints = deepFreeze({
  ...
  "read-the-evidence/scalar-gemm-checkpoint":
    "761f9b5e9c4a247b245c4833da9869f8c0df59ef28007501838f73a5d5374987",
  "reductions-scans/scan":
