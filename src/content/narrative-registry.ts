...
const narrativeRegistry = deepFreeze({
  ...
  "read-the-evidence/compiler-refactor": {
    ...
    "title": "Read the compiler refactor as infrastructure",
    "blocks": [
      {
        "type": "paragraph",
        "text": "The public compiler-refactor sequence through commit db7bfdc8e0f1ab559b21662262516d0e5498180e, tree 70eeb4b9ac25f73017007e75dac9156176c07926, adds bounded issue #134/#135 architecture infrastructure under the c84c272926c14496282cdd355b580f40c04de6a7 publication gate. It changes where models, contracts, dialect objects, exact-byte envelopes, transformation shells, selector routing, and authority boundaries live; it does not promote any kernel claim."
      },
      {
        "type": "table",
        "headers": [
        ...
        "rows": [
          ...
          [
            "Pinned Pliron D0",
            "A real Pliron context/pass shell is pinned to upstream Pliron v0.17.0 commit 2610651306ea3ba670f68d5d8b1e1159bcd521ed.",
            "D0 has no pliron-llvm path and does not select the production compiler."
          ],
          [
          ...
          [
            "Exact-byte KIR V1-V5 envelope",
            "Commit 7d783fdec1bc9439d0eadf2afde26dc2ab4f39fc stores canonical KIR bytes unchanged on a Pliron module with redundant wire-version, module-identity, and exact shell-projection checks, then returns the original bytes only after revalidation.",
            "Canonical bytes remain the only durable record. The projection is an inert index, not a second KIR serialization, semantic lowering, proof, target selection, or artifact authority."
          ],
          [
            "Terminal MIR to kernel shell",
            "Commit db7bfdc8e0f1ab559b21662262516d0e5498180e maps only one narrow verified MIR module shape to source-ordered kernel.algorithm_root operations with bounded traversal and rewrites.",
            "Unsupported operations, malformed structures, unsupported ranks, and exhausted bounds are terminal typed errors. There is no fallback and no result after failure; no general rustc MIR import or executable path is claimed."
          ],
          [
          ...
          [
            "Kernel to GPU lowering shell",
            "Commit 9796afeb62e9bb0063d0facf34a4f21b1876377e adds one bounded pass from kernel.algorithm_root to deterministic target-neutral gpu.* operations with abstract hierarchy, memory spaces, and optional workgroup synchronization.",
            "It cannot select AMDGCN, emit executable code, compile, link, publish, load, launch, tune, or grant proof/runtime authority."
          ]
        ]
      },
      {
        ...
        "text": "This infrastructure does not complete issue #134 or #135, change a run/verify/evidence gate, make any explanatory lesson kernel functional, establish performance, add GPU evidence, or promote cuda-oxide parity. Historical lesson evidence and source pins remain unchanged."
      },
      {
        "type": "paragraph",
