...
const cpuSimulation: Lesson = {
  ...
  objectives: [
    ...
    "Trace the source-to-MIR-to-KIR V6-to-formal-memory simulation boundary.",
  ...
  claims: [
    {
      ...
      detail:
        "The command compiles ordinary typed source through semantic MIR, verified canonical KIR V6, and formal-memory admission, then executes that exact KIR in the bounded deterministic CPU simulator. The no-hardware path neither initializes a GPU/device runtime nor predicts GPU performance.",
      reference: currentImplementationReference(
