...
test("row softmax shows dynamic source and GPU qualification", async ({
  ...
  await expect(
    ...
    "href",
    "https://github.com/harsh-nod/fe2o3/blob/fa2c53637039c81f671e2fb20ffb0b729ff1cd96/examples/row_softmax_general_v1/src/kernel.rs",
  );
...
test("MoE expert lesson exposes dynamic MFMA source and qualification evidence", async ({
  ...
  await expect(
    ...
    "href",
    "https://github.com/harsh-nod/fe2o3/blob/fa2c53637039c81f671e2fb20ffb0b729ff1cd96/examples/moe_grouped_expert_general_v1/src/kernel.rs",
  );
  ...
  await expect(
    ...
    "href",
    "https://github.com/harsh-nod/fe2o3/blob/fa2c53637039c81f671e2fb20ffb0b729ff1cd96/examples/verus_vecadd/verus/reference_refinement_v1.rs",
  );
...
test("every internal curriculum route resolves without page overflow", async ({
  ...
  await expect(
    page.getByRole("heading", {
      level: 2,
      name: "Compiler baseline at fa2c53637",
    }),
  ).toBeVisible();
  await expect(
