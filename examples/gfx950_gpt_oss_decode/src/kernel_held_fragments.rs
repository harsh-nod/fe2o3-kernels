...
pub fn gfx950_gpt_oss_120b_decode_megakernel_v1(
    ...
    let weight1 = weights.load_k128n16(&lane, expert_reduction_base.wrapping_add(EXPERT_K_TILE), 0);
    let weight2 = weights.load_k128n16(
        &lane,
        expert_reduction_base.wrapping_add(2 * EXPERT_K_TILE),
        0,
    );
    let weight3 = weights.load_k128n16(
        &lane,
